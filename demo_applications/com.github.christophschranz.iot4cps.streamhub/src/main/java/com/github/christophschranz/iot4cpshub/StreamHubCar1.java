...
public class StreamHubCar1 {

    public static void main(String[] args) {
        // write constants
        final String SYSTEM_NAME = "car1";  // must be unique (gets a consumergroup)
        final String INPUT_TOPIC = "eu.srfg.iot-iot4cps-wp5.car1.data";
        final String [] OUTPUT_TOPICS = {"eu.srfg.iot-iot4cps-wp5.car2.external"};
